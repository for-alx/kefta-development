...
def questions(exam_id):
    ...
    return render_template('question.html', user=current_user, questions=all_question, current_exam=current_exam)
...
def edit_question(question_id):
    if current_user.__class__.__name__ == 'Teacher':
        ...
        if request.method == 'POST':
            ...
            return redirect(url_for('question.questions', exam_id=edit_obj.exam_id))

        if edit_obj:
            return render_template('edit_question.html', user=current_user, edit_question=edit_obj)
        else:
